...
import com.project.Backend.Indus1.dao.*;
...
public class ProductController {
	...
	public String insertProduct(@ModelAttribute("product") Product product, Model m,BindingResult result)

	{
		...
		String path="C:\\Users\\Deepak kymar\\git\\Ecommerce\\IndusFrontend\\src\\main\\webapp\\resources\\images\\";
		System.out.println("images stored");
		String fileinfo=path+String.valueOf(product.getProdid())+".jpg";
