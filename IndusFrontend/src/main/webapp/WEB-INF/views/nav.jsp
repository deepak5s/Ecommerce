    ...
    <nav class="top-bar">
      <div class="container">
        ...
        <div class="col-sm-4 hidden-xs">
            <span class="nav-text">
                <i class="fa fa-phone" aria-hidden="true"></i>  8800142629
                <i class="fa fa-envelope" aria-hidden="true"></i> deepak_conio.h@hotmail.com</span>
            </div>
...
<nav class="navbar navbar-inverse">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><img src="C:\Users\Deepak kymar\git\Ecommerce\IndusFrontend\src\main\webapp\resources\images\wp00f5bf59_06.png"></a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-left">
        <li class=""><a href="ioo">Home</a></li>
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">About <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="AboutUs">Page 1-1</a></li>
