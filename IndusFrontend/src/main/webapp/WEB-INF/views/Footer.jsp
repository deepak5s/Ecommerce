...
<!-- Footer -->
	<div class="agileinfofooter">
		<div class="agileinfofooter-grids">
			...
			<div class="col-md-4 agileinfofooter-grid agileinfofooter-grid3">
				<address>
					<ul>
						<li>201009 sec62 Via highway</li>
						<li>Indus Inc.</li>
						<li>Ghazibad, India</li>
						<li>8800142629</li>
						<li><a class="mail" href="deepak_conio.h@hotmail.com">info@example.com</a></li>
					</ul>
				</address>
			</div>
	...
	<div class="w3lscopyrightaits">
		<div class="col-md-8 w3lscopyrightaitsgrid w3lscopyrightaitsgrid1">
			<p>© 2017 INDUSEZONE. All Rights Reserved | Design by <a href="http://INDUSINC.com/" target="=_blank"> INDUS INC.</a></p>
		</div>
